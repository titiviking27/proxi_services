...
<section class="middle">
    <div class="wrap">
        <div class="auteur">
            ...
            <p><input class="details" type="button" value="Editer l'article" ; onclick=window.location.href='admin/editpost.php?id=<?= $_GET['id']; ?>'></p>
            <p><input class="details" type="button" value="Supprimer l'article" ; onclick=window.location.href='admin/deletepost.php?id=<?= $_GET['id']; ?>'></p>
            <hr class="hr-text">
        </div>
    </div>
</section>
